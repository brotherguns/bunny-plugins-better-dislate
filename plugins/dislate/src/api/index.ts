...
export { DeepL, GTranslate, Gemini, Groq }
...
export async function translate(text: string, target_lang: string, original = false): Promise<TranslateResult> {
    switch (settings.translator) {
        ...
        case 2:  return Gemini.translate(text, undefined, target_lang, original)
        case 3:  return Groq.translate(text, undefined, target_lang, original)
        case 1:
